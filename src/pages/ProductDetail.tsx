...
const ProductDetail = () => {
  ...
  // Determine footer height to set proper padding
  const [footerHeight, setFooterHeight] = useState(152); // Default height
  ...
  useEffect(() => {
    ...
    // Add measurement after DOM updates that might affect footer height
