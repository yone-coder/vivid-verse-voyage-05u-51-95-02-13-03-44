...
return flex-1 py-3 text-center relative font-medium text-sm transition-all duration-200 ${     activeTab === tab ? 'text-white' : 'text-gray-400 hover:text-gray-200'     };
};
...
{/* Main content */}    
  ...
  <h1 className="text-2xl font-bold text-center mb-6">Log in to Spotify</h1>    
        <div className="space-y-4">    
          ...
          </button>    <button className="w-full py-3 px-4 border border-gray-700 rounded-full font-bold flex items-center justify-center space-x-2 hover:border-white transition-colors">    
        <svg className="w-5 h-5" viewBox="0 0 24 24">    
