  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-white text-[#333] py-8">
      <div className="w-full max-w-md px-4 flex flex-col items-center justify-center min-h-screen">
        {/* Header with logo - reduced vertical spacing */}
        ...
        {/* Main content - reduced spacing between elements */}
        <div className="w-full mb-4 space-y-4">
          <h1 className="text-2xl font-bold text-center mb-4">Log in to Mima</h1>
          <div className="space-y-4">
            {/* Horizontally scrollable social login section - adjusted spacing */}
            <div className="relative mb-4 w-full">
              ...
              <div className="flex justify-center items-center space-x-3 mt-2">
                {[0, 1, 2].map((pageIndex) => (
                  <div 
                    key={pageIndex}
                    className="h-1.5 rounded-full w-6 overflow-hidden bg-gray-200"
                  >
                    <div 
          ...
          <div className="relative border-b border-[#eaeaea] mb-4 mt-2">
            <div className="flex">
              <button 
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {step === 1 ? (
              <div className={`transition-opacity duration-150 ${tabTransition ? 'opacity-0' : 'opacity-100'}`}>
                <label htmlFor="login-input" className="block text-base font-medium mb-1.5 text-[#333]">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    value={email}
                    onChange={(e) => setEmail(e.target.value)}
                    className="w-full pl-10 pr-3 py-2.5 bg-white border border-[#e8e8e8] rounded-md text-[#333] placeholder-[#999] focus:outline-none focus:ring-2 focus:ring-[#ff4747] focus:border-transparent"
                    required
                  />
                </div>
              </div>
              ...
              <div className="relative">
                <label htmlFor="password" className="block text-base font-medium mb-1.5 text-[#333]">
                  Password
                </label>
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 py-2.5 bg-white border border-[#e8e8e8] rounded-md text-[#333] placeholder-[#999] focus:outline-none focus:ring-2 focus:ring-[#ff4747] focus:border-transparent"
                    required
                  />
                  <button
                    type="button"
            ...
            <button
              type="submit"
              className="w-full bg-[#ff4747] text-white font-medium py-2.5 px-4 rounded-md hover:bg-[#ff2727] transition-all focus:outline-none focus:ring-2 focus:ring-[#ff4747] focus:ring-offset-2 focus:ring-offset-white mt-4"
            >
              {step === 1 ? 'Next' : 'Log In'}
            </button>
        ...
        <div className="w-full mt-3 py-3 text-center">
