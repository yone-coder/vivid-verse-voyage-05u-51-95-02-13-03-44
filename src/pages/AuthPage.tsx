...
const SignInScreen = () => {
  ...
  return (
    <div className="flex flex-col justify-center min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      {/* Main content */}
      <div>
        <div className="flex border-b mb-6 px-4 mt-6">
        ...
        {activeTab === 'email' && (
          <form onSubmit={handleSubmit} className="space-y-4 px-4">
            <div>
              <label className="text-xs font-medium text-gray-600 mb-1 block">Email / Username</label>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 block text-xs text-gray-600">Remember me</label>
              </div>
            ...
            <button
              type="submit"
              className="w-full py-2 px-4 rounded-lg text-sm font-medium text-white bg-orange-500 hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500"
            >
              Sign in
            </button>
          </form>
        ...
        {activeTab === 'phone' && (
          <div className="space-y-4 px-4">
            <div>
              ...
              <div className="flex">
                <select className="w-1/4 mr-2 py-2 px-3 border border-gray-300 rounded-lg focus:ring-orange-500 text-sm">
                  <option>+1</option><option>+44</option><option>+86</option><option>+91</option>
                </select>
                <input
                  type="tel"
                  className="w-3/4 py-2 px-3 border border-gray-300 rounded-lg focus:ring-orange-500 text-sm"
            ...
            <div>
              ...
              <div className="flex">
                <input
                  type="text"
                  className="w-2/3 mr-2 py-2 px-3 border border-gray-300 rounded-lg focus:ring-orange-500 text-sm"
                  placeholder="6-digit code"
                />
                <button className="w-1/3 py-2 px-3 text-xs font-medium text-white bg-orange-500 rounded-lg hover:bg-orange-600">
                  Get Code
                </button>
              </div>
            </div>

            <button className="w-full py-2 px-4 text-sm font-medium text-white bg-orange-500 rounded-lg hover:bg-orange-600">
              Sign in
            </button>
          </div>
        )}
        ...
        {activeTab === 'qr' && (
          <div className="py-10 flex flex-col items-center justify-center px-4">
            ...
            <p className="mt-4 text-xs text-gray-500 text-center">Scan with the AliExpress app to sign in instantly</p>
          </div>
        )}
        ...
        <div className="mt-8 px-4">
          ...
          <div className="mt-6 grid grid-cols-3 gap-3">
            <button className="w-full py-2 border border-gray-300 rounded-lg bg-white text-gray-500 hover:bg-gray-50">
              <Facebook size={16} />
            </button>
            <button className="w-full py-2 border border-gray-300 rounded-lg bg-white text-gray-500 hover:bg-gray-50">
              <Github size={16} />
        ...
        <p className="mt-6 text-center text-xs text-gray-600 px-4">
          Not a member yet?{' '}
          <a href="#" className="font-medium text-orange-600 hover:text-orange-500">Create an account</a>
        </p>
      </div>
