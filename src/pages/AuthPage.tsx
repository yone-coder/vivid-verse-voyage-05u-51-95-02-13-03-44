            ...
            <>
              ...
              <div className="space-y-4 mb-8">
                ...
                <button 
                  ...
                  className="w-full bg-black border border-gray-600 hover:border-gray-400 text-white font-semibold py-3 px-4 rounded-full flex items-center justify-center gap-3 transition-colors"
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" className="fill-current">
                ...
                <div>
                  ...
                  {loginMethod === 'email' ? (
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-md text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-md text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent pr-12"
