...
const AuthPage = () => {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-white text-[#333]">
      ...
      <div className="w-full max-w-md px-6">
        ...
        <div className="space-y-4">
          ...
          <div className="relative mb-6 w-full">
            {/* Full width scroll container with proper edge behavior */}
            <div className="w-full -mx-6"> {/* Negative margin to break out of parent padding */}
              <div 
                ref={carouselRef}
                className="flex overflow-x-auto snap-x snap-mandatory pl-6 scroll-pl-6"
                style={{ 
                  scrollbarWidth: 'none', 
            ...
            <div className="flex justify-center items-center space-x-2 mt-2">
              {[0, 1, 2].map((pageIndex) => (
                <div 
                  key={pageIndex}
                  className="h-1 rounded-full w-8 overflow-hidden bg-gray-200"
                >
                  <div 
      ...
      <div className="w-full mt-auto py-4 text-center">
