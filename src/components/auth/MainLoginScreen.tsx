...
const MainLoginScreen: React.FC<MainLoginScreenProps> = ({ 
  ...
  <button className="w-full flex items-center justify-start gap-3 py-3 px-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
  ...
  <button 
    ...
    className="w-full flex items-center justify-start gap-3 py-3 px-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
  >
