...
import TabDivider from '@/components/auth/tabs/TabDivider';
import TabNavigation from '@/components/auth/tabs/TabNavigation';
import EmailTab from '@/components/auth/tabs/EmailTab';
import PhoneTab from '@/components/auth/tabs/PhoneTab';
import PasskeyTab from '@/components/auth/tabs/PasskeyTab';
