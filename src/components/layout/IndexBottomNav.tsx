            ...
            item.isCenter ? (
              <div key={item.id} className="flex flex-col items-center justify-center w-1/5">
                <button
                  ...
                  className="w-12 h-12 rounded-full bg-gradient-to-tr from-red-500 to-red-400 flex items-center justify-center shadow-lg border-2 border-white dark:border-zinc-800"
                  style={{
                ...
                <span className="text-[10px] mt-1 font-medium text-red-500">Add</span>
              </div>
            ) : (
              <Link
                key={item.id}
