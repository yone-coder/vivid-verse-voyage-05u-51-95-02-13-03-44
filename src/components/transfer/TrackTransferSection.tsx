...
import { Route, Package, Truck, CheckCircle, Clock, AlertCircle, MapPin, Calendar, DollarSign } from 'lucide-react';
...
const TrackTransferSection: React.FC = () => {
            ...
            <CardHeader>
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-muted-foreground">To {transfer.recipient}</p>
                </div>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="font-medium">{formatDate(transfer.estimatedDelivery)}</p>
...
export default TrackTransferSection;
