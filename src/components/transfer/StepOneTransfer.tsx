          ...
          <div className="relative">
            ...
            <div className="absolute inset-y-0 right-3 flex items-center">
              <Select value={selectedCurrency} onValueChange={setSelectedCurrency}>
                <SelectTrigger className="h-6 w-auto border-0 bg-slate-100 text-slate-700 font-bold text-xs px-2 py-1 rounded-full focus:ring-0 shadow-none">
      ...
      <div className="bg-white rounded-xl border border-slate-300 p-4 shadow-sm">
        <div className="space-y-2">
          ...
          <div className="border-t border-slate-200 pt-2">
            <div className="flex items-center justify-between">
              <span className="font-bold text-slate-800 text-sm">Total to pay</span>
