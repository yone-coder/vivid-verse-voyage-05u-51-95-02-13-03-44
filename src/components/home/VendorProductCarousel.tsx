...
import { FaThumbsUp, FaCommentAlt, FaShare } from 'react-icons/fa'; import { Product } from '@/integrations/supabase/products';
...
{/* Post Description */}  
  ...
  {/* Social Buttons */}  
  <div className="flex items-center gap-6 px-3 md:px-4 mb-4 text-gray-600">  
