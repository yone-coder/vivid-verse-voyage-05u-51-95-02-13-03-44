...
const vendors = [
  {
    ...
    fastShipping: true,
    topProducts: [
      { id: 1, image: 'https://via.placeholder.com/80?text=Phone', price: '$299.99' },
      { id: 2, image: 'https://via.placeholder.com/80?text=Watch', price: '$149.99' },
      { id: 3, image: 'https://via.placeholder.com/80?text=Headphones', price: '$89.99' },
    ],
  },
  {
    id: 2,
    name: 'StyleCraze',
    image: 'https://via.placeholder.com/300x100?text=Fashion',
    rating: 4.5,
    sales: 2200,
    verified: true,
    topSeller: false,
    fastShipping: true,
    topProducts: [
      { id: 1, image: 'https://via.placeholder.com/80?text=Dress', price: '$39.99' },
      { id: 2, image: 'https://via.placeholder.com/80?text=Sneakers', price: '$59.99' },
      { id: 3, image: 'https://via.placeholder.com/80?text=Bags', price: '$34.99' },
    ],
  },
  {
    id: 3,
    name: 'HomeEssence',
    image: 'https://via.placeholder.com/300x100?text=Home+Store',
    rating: 4.8,
    sales: 4100,
    verified: true,
    topSeller: true,
    fastShipping: false,
    topProducts: [
      { id: 1, image: 'https://via.placeholder.com/80?text=Lamp', price: '$24.99' },
      { id: 2, image: 'https://via.placeholder.com/80?text=Rug', price: '$79.99' },
      { id: 3, image: 'https://via.placeholder.com/80?text=Cushion', price: '$12.99' },
    ],
  },
  {
    id: 4,
    name: 'BeautyBasics',
    image: 'https://via.placeholder.com/300x100?text=Beauty',
    rating: 4.6,
    sales: 1850,
    verified: false,
    topSeller: false,
    fastShipping: true,
    topProducts: [
      { id: 1, image: 'https://via.placeholder.com/80?text=Serum', price: '$29.99' },
      { id: 2, image: 'https://via.placeholder.com/80?text=Cream', price: '$19.99' },
      { id: 3, image: 'https://via.placeholder.com/80?text=Mask', price: '$14.99' },
    ],
  },
  {
    id: 5,
    name: 'FitGear',
    image: 'https://via.placeholder.com/300x100?text=Sports',
    rating: 4.4,
    sales: 1340,
    verified: true,
    topSeller: false,
    fastShipping: true,
    topProducts: [
      { id: 1, image: 'https://via.placeholder.com/80?text=Gloves', price: '$9.99' },
      { id: 2, image: 'https://via.placeholder.com/80?text=Shaker', price: '$12.99' },
      { id: 3, image: 'https://via.placeholder.com/80?text=Mat', price: '$25.99' },
    ],
  },
];
