...
export default function FlashDeals() {
  ...
  <div className="flex justify-between items-center mb-1">
    <div className="flex items-center">
      {/* Wrap the red background in a full-height flex container */}
      <div className="flex items-stretch">
        <div className="flex items-center bg-[#FF4747] text-white text-xs font-semibold px-2 py-0.5 rounded-sm uppercase tracking-wide h-full">
          <Zap className="w-3.5 h-3.5 mr-1" />
          Flash Sale
        </div>
      </div>
      <div className="flex items-center space-x-1 ml-2 text-[11px] text-gray-500 font-medium">
