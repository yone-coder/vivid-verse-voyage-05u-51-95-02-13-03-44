      ...
      <div className="container mx-auto px-3">
        <div className="flex justify-between items-center mb-2">
          <div className="flex items-center">
            <h2 className="text-sm font-bold text-purple-600 mr-2">Limited Offers</h2>
            <div className="flex items-center gap-1">
              <Sparkles className="h-3 w-3 text-purple-600" />
              <div className="text-xs font-medium">
                <span className="inline-flex items-center justify-center bg-purple-900 text-white h-4 w-5 rounded text-[10px]">
          ...
          <Link to="#" className="text-xs text-purple-600 hover:underline flex items-center">
