      ...
      <div className="flex items-center justify-between px-4 h-14">
        ...
        <div className="flex-1 mx-4" ref={searchRef}>
          ...
          >
            ...
            <input
              className="py-1 px-2 text-sm outline-none bg-gray-100 placeholder-gray-400 w-full"
        ...
        <div className="flex items-center space-x-3">
          <div className="cursor-pointer relative p-1 rounded-full hover:bg-gray-200">
