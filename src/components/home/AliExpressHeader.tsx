      ...
      <div className="flex items-center justify-between px-2 h-full">
        ...
        <div className="flex flex-1 mx-2" ref={searchRef}>
          ...
          >
            ...
            <input
              className="ml-1 text-xs bg-gray-100 outline-none w-full placeholder-gray-400"
              placeholder="Search"
              value={searchQuery}
            ...
            {searchQuery && (
              <div
                className="ml-1 cursor-pointer rounded-full hover:bg-gray-200"
        ...
        <div className="flex items-center space-x-2 flex-shrink-0">
          <div className="relative cursor-pointer hover:bg-gray-100 p-1 rounded-full">
