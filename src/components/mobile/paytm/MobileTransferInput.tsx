...
const MobileTransferInput: React.FC<MobileTransferInputProps> = ({ amount, onAmountChange }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-xl p-3 border border-[#ff4747]/20">
      ...
      {/* Send Amount Input */}
      <div className="bg-white rounded-xl border border-[#ff4747]/30 overflow-hidden">
      ...
      {/* Fee Breakdown */}
      <div className="bg-gradient-to-r from-gray-50 to-orange-50 rounded-xl border border-orange-200 p-3">
...
export default MobileTransferInput;
