    ...
    <>
      ...
      <path 
        ...
        style={{
          ...
          animation: isExiting 
            ? SPLASH_ANIMATIONS.configs.logoExit
            : `${SPLASH_ANIMATIONS.configs.logoEntry}, fill-path-physics 1.2s ease-out 2.5s forwards, physics-vibration 0.8s ease-in-out 3.7s infinite`,
          willChange: isExiting ? 'transform, filter, opacity, fill, stroke' : 'stroke-dashoffset, transform'
        }}
        role="img"
