...
const ProductTabs: React.FC<ProductTabsProps> = ({
  ...
  const isTabExpanded = (tabId: string) => expandedTabs[tabId] || !previewMode;
              ...
              <CardContent className="p-0">
                ...
                {previewMode && (
                  <div className="p-4">
                    ...
                    >
                      {isTabExpanded("description") ? "Show Less" : "View More"} 
                      {isTabExpanded("description") ? <ChevronDown className="h-4 w-4" /> : <ChevronRight className="h-4 w-4" />}
                    </Button>
                  </div>
                )}
              </CardContent>
            ...
            <Card className="border-0 shadow-none">
              <CardContent className="p-4">
                ...
                <div className="mb-4">
                  ...
                  <div className="bg-gray-50 rounded-lg overflow-hidden">
                    <div className="divide-y">
                      {product.specs.slice(0, isTabExpanded("specs") ? 3 : getPreviewLimit("specs")).map((spec, index) => (
                ...
                {previewMode && (
                  ...
                  >
                    {isTabExpanded("specs") ? "Show Less" : "View More"} 
                    {isTabExpanded("specs") ? <ChevronDown className="h-4 w-4" /> : <ChevronRight className="h-4 w-4" />}
                  </Button>
                )}
              </CardContent>
            </Card>
              ...
              <CardContent className="p-4">
                ...
                {previewMode && (
                  <Button 
                    ...
                    className="w-full flex items-center justify-center gap-2 text-red-500 border-red-500 mt-2"
                  >
                    {isTabExpanded("reviews") ? "Show Less" : "View More"} 
                    {isTabExpanded("reviews") ? <ChevronDown className="h-4 w-4" /> : <ChevronRight className="h-4 w-4" />}
                  </Button>
                )}
              </CardContent>
            </Card>
