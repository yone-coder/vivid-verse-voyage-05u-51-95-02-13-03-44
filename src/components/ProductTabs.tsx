...
const ProductTabs: React.FC<ProductTabsProps> = ({
  ...
  const getActiveContentRef = () => {
    switch (activeTab) {
      case 'description':
        return descriptionContentRef;
      case 'specs':
        return specsContentRef;
      case 'reviews':
        return reviewsContentRef;
      default:
        return descriptionContentRef;
    }
  };
  ...
  useEffect(() => {
    const activeContentRef = getActiveContentRef();
  ...
  return (
    ...
    >
      ...
      <TabsContent value="description" className="mt-0">
        <div ref={descriptionContentRef} className="overflow-auto h-full max-h-[calc(100vh-200px)]">
      ...
      <TabsContent value="specs" className="mt-0">
        <div ref={specsContentRef} className="overflow-auto h-full max-h-[calc(100vh-200px)]">
          <Card className="border-0 shadow-none">
            <CardContent className="p-4">
      ...
      <TabsContent value="reviews" className="mt-0">
        <div ref={reviewsContentRef} className="overflow-auto h-full max-h-[calc(100vh-200px)]">
          <Card className="border-0 shadow-none">
            <CardContent className="p-4">
