...
interface DesktopTransferSheetPageProps {
  defaultTransferType?: 'international' | 'national';
}

const DesktopTransferSheetPage: React.FC<DesktopTransferSheetPageProps> = ({
        ...
        <div className="bg-blue-600 text-white">
          <div className="flex items-center justify-between px-6 py-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-xl font-bold">GLOBAL TRANSFÈ</h1>
            </div>
        ...
        <div className="grid grid-cols-12 gap-8 p-6">
          ...
          <div className="col-span-3">
            <div className="bg-white rounded-lg border border-gray-200 p-6 sticky top-6">
              <h3 className="font-semibold text-gray-900 mb-6">Transfer Progress</h3>
                    ...
                    <div className="flex flex-col items-center mr-4">
                      <motion.div
                        className={`rounded-full flex items-center justify-center text-sm font-medium transition-all duration-300 shadow-sm ${
                          step === currentStep
                            ? 'w-10 h-10 bg-red-600 text-white'
                            : step < currentStep
              ...
              {/* Transfer Summary - Show from step 2 onwards */}
              {currentStep > 1 && (
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-8">
              ...
              {currentStep < 4 && (
                <div className="flex justify-between mt-12 pt-8 border-t border-gray-200">
                  ...
                  <Button
                    onClick={currentStep === 3 ? handleStickyPayment : handleNextStep}
                    disabled={
                      !canProceed || 
                      isPaymentLoading || 
                    ...
                    className={cn(
                      "flex items-center transition-all duration-200 text-white font-semibold px-8",
                      getButtonColor()
                    )}
                  >
                    {isPaymentLoading ? (
